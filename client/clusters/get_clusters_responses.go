...
func (o *GetClustersOK) Error() string {
	return fmt.Sprintf("[GET /v4/clusters/][%d] getClustersOK  %+v", 200, o.Payload)
}
...
func (o *GetClustersUnauthorized) Error() string {
	return fmt.Sprintf("[GET /v4/clusters/][%d] getClustersUnauthorized  %+v", 401, o.Payload)
}
...
func (o *GetClustersDefault) Error() string {
	return fmt.Sprintf("[GET /v4/clusters/][%d] getClusters default  %+v", o._statusCode, o.Payload)
}
