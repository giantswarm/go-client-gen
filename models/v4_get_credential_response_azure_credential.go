...
// V4GetCredentialResponseAzureCredential Service principal credential
// swagger:model v4GetCredentialResponseAzureCredential
...
func (m *V4GetCredentialResponseAzureCredential) Validate(formats strfmt.Registry) error {
	return nil
}
...
func (m *V4GetCredentialResponseAzureCredential) UnmarshalBinary(b []byte) error {
	var res V4GetCredentialResponseAzureCredential
