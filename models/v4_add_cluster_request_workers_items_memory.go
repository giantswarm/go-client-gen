...
// V4AddClusterRequestWorkersItemsMemory v4 add cluster request workers items memory
// swagger:model v4AddClusterRequestWorkersItemsMemory
...
func (m *V4AddClusterRequestWorkersItemsMemory) Validate(formats strfmt.Registry) error {
	return nil
}
...
func (m *V4AddClusterRequestWorkersItemsMemory) UnmarshalBinary(b []byte) error {
	var res V4AddClusterRequestWorkersItemsMemory
