...
func (m *V4App) validateMetadata(formats strfmt.Registry) error {
...
func (m *V4App) validateSpec(formats strfmt.Registry) error {
...
func (m *V4App) validateStatus(formats strfmt.Registry) error {
