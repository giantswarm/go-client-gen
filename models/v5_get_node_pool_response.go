...
func (m *V5GetNodePoolResponse) validateAvailabilityZones(formats strfmt.Registry) error {
...
func (m *V5GetNodePoolResponse) validateID(formats strfmt.Registry) error {
...
func (m *V5GetNodePoolResponse) validateSubnet(formats strfmt.Registry) error {
